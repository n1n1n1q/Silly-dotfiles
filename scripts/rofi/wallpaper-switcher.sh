...
swww img ${wall_dir}/${wall_selection}  --transition-fps 60 --transition-type any --transition-duration 3
wal -i ${wall_dir}/${wall_selection}
~/scripts/waybarColors.sh
killall -SIGUSR2 waybar
walogram -B
cp ${wall_dir}/${wall_selection} ~/.cache/currb
convert ~/.cache/currb -blur 8x20 ~/.cache/currbg
rm ~/.cache/currb
exit 0
